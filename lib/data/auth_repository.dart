...
class MockAuthRepository implements AuthRepository {
  ...
  Future<String> signInAnonymously() async {
    _user = const AuthUser(uid: MockData.currentUserId, isAnonymous: true);
  ...
  Future<void> linkEmail(
    ...
    _user = AuthUser(uid: uid, isAnonymous: false, email: email);
    _controller.add(_user);
  }
  ...
  Future<void> linkGoogle() async {
    final uid = _user?.uid ?? MockData.currentUserId;
    _user = AuthUser(uid: uid, isAnonymous: false, email: 'me@gmail.com');
    _controller.add(_user);
  }
  ...
  Future<void> signInWithEmail(
      {required String email, required String password}) async {
    _user = AuthUser(
        uid: MockData.currentUserId, isAnonymous: false, email: email);
    _controller.add(_user);
  }
  ...
  Future<void> signInWithGoogle() async {
    _user = const AuthUser(
        uid: MockData.currentUserId, isAnonymous: false, email: 'me@gmail.com');
    _controller.add(_user);
  }
